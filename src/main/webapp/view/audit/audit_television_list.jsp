...
<%--            <td align="center">审核备注</td>--%>
        ...
        <c:forEach var="item" items="${pager.list}" varStatus="status">
            <tr>
                ...
                <td align="center">
                    <div class="layui-btn-group">
                        <button type="button" class="layui-btn layui-btn-sm " onclick="audit('${item.tvId}')">
...
<script>
    ...
    function audit(id){
        layer.open({
            ...
            time: 0, //0秒后自动关闭
            anim: 2,
            content: ['${rootPath}/view/audit/audit_supplier_detail.html?id='+id+'&path=${rootPath}', 'no'], //iframe的url，no代表不显示滚动条
